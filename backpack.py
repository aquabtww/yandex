...
if __name__ == "__main__":
    ...
    backpack_bg = pygame.image.load("backpack.png").convert()
    ...
    items = {
        "Полнолуние": Item("Полнолуние", pygame.image.load("loot1.png").convert_alpha()),
        "Ласточка": Item("Ласточка", pygame.image.load("loot2.png").convert_alpha()),
        "Филин": Item("Филин", pygame.image.load("loot3.png").convert_alpha()),
        "Бякко": Item("Бякко", pygame.image.load("loot4.png").convert_alpha()),
        "Черная дурь": Item("Черная дурь", pygame.image.load("loot5.png").convert_alpha()),
        "": None
    }
